...
public class TAPNQuery {
	...
	public enum ReductionOption {NAIVE, NAIVE_UPPAAL_SYM, ADV_UPPAAL_SYM, ADV_NOSYM, INHIB_TO_PRIO_STANDARD, INHIB_TO_PRIO_SYM, BROADCAST_STANDARD, BROADCAST_SYM, BROADCAST_DEG2_SYM, ADV_BROADCAST_SYM};
