...
public class QueryDialogue extends JPanel{
	...
	private void initQueryPanel(final TAPNQuery queryToCreateFrom) {
		...
		queryField.setAlignmentY(CENTER_ALIGNMENT);
//		queryField.setFont(PROPERTY_FONT);
//		queryField.setSelectionColor(SELECTED_BG_COLOR);
//		queryField.setSelectedTextColor(SELECTED_FG_COLOR);
...
//		if(currentSelection.getObject() instanceof TCTLAFNode || currentSelection.getObject() instanceof TCTLAGNode || 
//				currentSelection.getObject() instanceof TCTLEFNode || currentSelection.getObject() instanceof TCTLEGNode) {
//			if(getQuantificationSelection().equals("E[]")) {
//				property = new TCTLEGNode(getStateChild(1,currentSelection.getObject()));
//			}
//			else if(getQuantificationSelection().equals("E<>")) {
//				property = new TCTLEFNode(getStateChild(1, currentSelection.getObject()));
//			}
//			else if(getQuantificationSelection().equals("A<>")) {
//				property = new TCTLAFNode(getStateChild(1, currentSelection.getObject()));
//			}
//			else { // A[]
//				property = new TCTLAGNode(getStateChild(1, currentSelection.getObject()));
//			}
//
//			newProperty = newProperty.replace(currentSelection.getObject(), property);
//			updateSelection(property);
