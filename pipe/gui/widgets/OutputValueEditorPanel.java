...
public class OutputValueEditorPanel extends JPanel {
	...
	public OutputValueEditorPanel(JRootPane rootPane, ColoredOutputArc arc,
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (normalRadioButton.isSelected()) {
					output.setOutputValue((Integer) integerValueSpinner
							.getValue());
				} else {
					output.setConstantName((String) constantDropDown
							.getSelectedItem());
				}
	...
	private void initOutputValuePanel() {
		...
		outputValuePanel.setBorder(BorderFactory
				.createTitledBorder("Output Value"));
