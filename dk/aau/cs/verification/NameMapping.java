...
public class NameMapping {
	...
	public void addMapping(String templateName, String objectName, String mappedName){
		...
		if(mappedNamesToOriginalNames.containsKey(mappedName)) throw new RuntimeException(mappedName + " already maps to a value");
		if(originalToMappedNames.containsKey(value)) throw new RuntimeException(templateName + "." + objectName + " already maps to a value");
