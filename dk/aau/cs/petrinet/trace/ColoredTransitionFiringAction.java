...
public class ColoredTransitionFiringAction implements TAPNFiringAction {
	...
	public ColoredTransitionFiringAction(TAPNTransition transition,
			List<ColoredToken> consumedTokens, List<ColoredToken> producedTokens) {
