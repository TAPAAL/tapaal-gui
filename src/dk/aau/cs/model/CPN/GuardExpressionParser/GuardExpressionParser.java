...
public class GuardExpressionParser implements GuardExpressionParserConstants {
  ...
  final public GuardExpression OrExpr() throws ParseException {
    ...
    default:
      ...
      ;
          ...
          {if (true) return right == null ? left : new OrExpression(left,right);}
    throw new Error("Missing return statement in function");
  }

  final public GuardExpression AndExpr() throws ParseException {
        GuardExpression left = null;
        GuardExpression right = null;
    left = NotExpr();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      ;
          ...
          {if (true) return right == null ? left : new AndExpression(left,right);}
    throw new Error("Missing return statement in function");
  }

  final public GuardExpression NotExpr() throws ParseException {
    ...
    case NOT:
      ...
      currentChild = OrExpr();
      jj_consume_token(16);
                                                {if (true) return new NotExpression(currentChild);}
      break;
    case IDENT:
    case 15:
      currentChild = term();
  ...
  final public GuardExpression term() throws ParseException {
    GuardExpression childExpression;
    if (jj_2_1(2147483647)) {
      childExpression = parseOperatorExpression();
                                                     {if (true) return childExpression;}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 15:
        jj_consume_token(15);
  ...
  final public GuardExpression parseOperatorExpression() throws ParseException {
    ...
    right = ColorExpression();
       ...
       if(op.image.equals("<")) {if (true) return new LessThanExpression(left,right);}
       else if(op.image.equals("<=")) {if (true) return new LessThanEqExpression(left,right);}
       else if(op.image.equals(">")) {if (true) return new GreaterThanExpression(left,right);}
       else if(op.image.equals(">=")) {if (true) return new GreaterThanEqExpression(left,right);}
       else if(op.image.equals("=")) {if (true) return new EqualityExpression(left,right);}
       else if(op.image.equals("!=")) {if (true) return new InequalityExpression(left,right);}
       else {if (true) return null;}
    throw new Error("Missing return statement in function");
  }

  final public ColorExpression ColorExpression() throws ParseException {
    ...
    case 15:
      ...
      {if (true) return cexpr;}
      break;
    case IDENT:
      subexpression = Element();
                                {if (true) return subexpression;}
      break;
    default:
      jj_la1[7] = jj_gen;
      jj_consume_token(-1);
  ...
  final public ColorExpression Element() throws ParseException {
    Token name;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2,0x4,0x8208,0x8000,0x20000,0xc0000,0xc0000,0x8200,0xc0000,0xc0000,};
   }
