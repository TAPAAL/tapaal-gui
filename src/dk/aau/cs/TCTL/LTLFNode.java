...
public class LTLFNode extends TCTLAbstractPathProperty {
    ...
    public LTLFNode(TCTLAbstractStateProperty property) {
        this.property = property;
        this.property.setParent(this);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof LTLFNode) {
            LTLFNode node = (LTLFNode) o;
    ...
    public TCTLAbstractPathProperty copy() {
        return new LTLFNode(property.copy());
    }
