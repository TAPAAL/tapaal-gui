...
public class TAPAALQueryParser implements TAPAALQueryParserConstants {
    ...
    /** Root production. */
    final public TCTLAbstractProperty Start() throws ParseException {TCTLAbstractProperty child = null;
        child = AbstractProperty();
        jj_consume_token(0);
        {if ("" != null) return child;}
        throw new Error("Missing return statement in function");
    }

    final public TCTLAbstractProperty AbstractProperty() throws ParseException {TCTLAbstractStateProperty child = null;
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case EF:{
                jj_consume_token(EF);
                child = OrExpr();
                {if ("" != null) return new TCTLEFNode(child);}
                break;
            }
            case EG:{
                jj_consume_token(EG);
                child = OrExpr();
                {if ("" != null) return new TCTLEGNode(child);}
                break;
            }
            case AF:{
                jj_consume_token(AF);
                child = OrExpr();
                {if ("" != null) return new TCTLAFNode(child);}
                break;
            }
            case AG:{
                jj_consume_token(AG);
                child = OrExpr();
                {if ("" != null) return new TCTLAGNode(child);}
                break;
            }
            default:
                jj_la1[0] = jj_gen;
    ...
    private boolean jj_3R_AritmeticFactor_256_17_11()
    {
        Token xsp;
        xsp = jj_scanpos;
    ...
    private boolean jj_3R_AritmeticExpr_215_9_6()
    {
        if (jj_3R_AritmeticTerm_234_9_7()) return true;
        Token xsp;
        while (true) {
            xsp = jj_scanpos;
            if (jj_3R_AritmeticExpr_218_17_8()) { jj_scanpos = xsp; break; }
        }
        return false;
    }

    private boolean jj_3R_AritmeticTerm_234_9_7()
    {
        if (jj_3R_AritmeticFactor_255_9_9()) return true;
        Token xsp;
        while (true) {
            xsp = jj_scanpos;
            if (jj_3R_AritmeticTerm_237_17_10()) { jj_scanpos = xsp; break; }
        }
        return false;
    }

    private boolean jj_3R_AritmeticFactor_255_9_9()
    {
        Token xsp;
        xsp = jj_scanpos;
        if (jj_3R_AritmeticFactor_256_17_11()) {
            jj_scanpos = xsp;
            if (jj_3R_AritmeticFactor_257_19_12()) {
                jj_scanpos = xsp;
                if (jj_3R_AritmeticFactor_258_19_13()) return true;
            }
        }
        return false;
    }
    ...
    {
        if (jj_3R_AtomicProposition_200_9_5()) return true;
        return false;
    }

    private boolean jj_3R_AritmeticExpr_218_17_8()
    {
    ...
    private boolean jj_3R_AtomicProposition_200_9_5()
    {
        if (jj_3R_AritmeticExpr_215_9_6()) return true;
        if (jj_scan_token(OP)) return true;
        if (jj_3R_AritmeticExpr_215_9_6()) return true;
        return false;
    }

    private boolean jj_3R_AritmeticFactor_258_19_13()
    {
    ...
    private boolean jj_3R_AritmeticTerm_237_17_10()
    {
    ...
    private boolean jj_3R_AritmeticFactor_257_19_12()
    {
