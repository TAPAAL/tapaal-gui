...
public class TCTLEXNode extends TCTLAbstractPathProperty {
	...
	public TCTLEXNode(TCTLAbstractStateProperty property) {
		this.property = property;
		this.property.setParent(this);
	}
	...
	public boolean equals(Object o) {
		if (o instanceof TCTLEXNode) {
			TCTLEXNode node = (TCTLEXNode) o;
	...
	public TCTLAbstractPathProperty copy() {
		return new TCTLEXNode(property.copy());
	}
