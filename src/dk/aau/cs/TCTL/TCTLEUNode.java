...
public class TCTLEUNode extends TCTLAbstractPathProperty {
	...
	public TCTLEUNode(TCTLAbstractStateProperty left, TCTLAbstractStateProperty right) {
		this.left = left;
		this.right = right;
	...
	public boolean equals(Object o) {	
		if (o instanceof TCTLEUNode) {
			TCTLEUNode node = (TCTLEUNode) o;
	...
	public String toString() {
		...
		return "E (" + leftString + " U " + rightString + ")";
	}

	@Override
	public TCTLAbstractPathProperty copy() {
		return new TCTLEUNode(left.copy(), right.copy());
	}
