...
/** Root production. */
  ...
  final public TCTLAbstractStateProperty NotExpr() throws ParseException {
    ...
    case 25:
      ...
      jj_consume_token(26);
                                                        {if (true) return new TCTLPathToStateConverter(childConverter);}
      break;
    default:
      jj_la1[3] = jj_gen;
      child = Factor();
  ...
  final public TCTLAbstractStateProperty AtomicProposition() throws ParseException {
    ...
    right = AritmeticExpr();
            ...
            {if (true) return new TCTLAtomicPropositionNode(new TCTLPlusListNode(forSingleChild), op.image, right);}
        } else {
