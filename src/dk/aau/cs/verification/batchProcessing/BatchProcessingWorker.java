...
public class BatchProcessingWorker extends SwingWorker<Void, BatchProcessingVerificationResult> {
	...
	private void processSoundnessCheck(final File file, Tuple<TimedArcPetriNet, NameMapping> composedModel, final net.tapaal.gui.petrinet.verification.TAPNQuery queryToVerify) throws Exception{
		...
		if(queryToVerify.getWorkflowMode() == WorkflowMode.WORKFLOW_STRONG_SOUNDNESS) {
			...
			net.tapaal.gui.petrinet.verification.TAPNQuery queryToCheckIfSound = new net.tapaal.gui.petrinet.verification.TAPNQuery(
	...
	private VerificationResult<TimedArcPetriNetTrace> verifyQuery(File file, Tuple<TimedArcPetriNet, NameMapping> composedModel, net.tapaal.gui.petrinet.verification.TAPNQuery query) throws Exception {
