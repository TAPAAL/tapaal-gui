...
public class VerifyTAPN implements ModelChecker {
	...
	private VerificationResult<TAPNTrace> verify(VerificationOptions options, Tuple<TimedArcPetriNet, NameMapping> model, ExportedVerifyTAPNModel exportedModel) {
