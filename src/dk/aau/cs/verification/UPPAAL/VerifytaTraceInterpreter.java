...
public class VerifytaTraceInterpreter {
	...
	protected TAPNFiringAction interpretTransitionFiring(List<TransitionFiring> firingSequence,	TransitionTranslation transitionTranslation, boolean isConcreteTrace) {
