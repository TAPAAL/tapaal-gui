...
public class TextLabel extends JLabel {
	...
	public TextLabel(DrawingSurface drawingSurface, JComponent owner,
			Point locationRelativeTo, String text) {
		this.drawingSurface = drawingSurface;
		this.owner = owner;

		setFont(new Font(Pipe.LABEL_FONT, Font.BOLD,
		...
		setText(text);
		setLocation(locationRelativeTo.x - getPreferredSize().width,
				locationRelativeTo.y);
		updateSize();
	}
	...
	public void addMouseListeners() {
		...
		MouseWheelAndClickPassThroughHandler clickAndWheelHandler = new MouseWheelAndClickPassThroughHandler(
				owner);
	...
	private class MouseWheelAndClickPassThroughHandler extends
			MouseInputAdapter {
