...
public class NetworkState {
    ...
    private final List<RealConstant> realConstants;
    ...
    public NetworkState(TimedArcPetriNetNetwork network) {
        ...
        this.realConstants = network.realConstants().stream().collect(Collectors.toList());
    ...
    public NetworkState(NetworkState state) {
        ...
        this.realConstants = state.getRealConstants();
