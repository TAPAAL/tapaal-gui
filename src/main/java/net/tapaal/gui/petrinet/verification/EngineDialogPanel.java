...
public class EngineDialogPanel {	
	...
	private void selectTapnEngine() {
		...
		try {
			File file = fileFinder.ShowFileBrowserDialog("Verifytapn", engineExstension, (new VerifyTAPN(new FileFinder(), new MessengerImpl())).getPath());
			if(file != null){
	...
	private void selectdTapnEngine() {
		...
		String verifytapnpath = null;
		try {
			File file = fileFinder.ShowFileBrowserDialog("Verifydtapn", engineExstension, (new VerifyDTAPN(new FileFinder(), new MessengerImpl())).getPath());
			if(file != null){
	...
	private void selectVerifytaEngine() {
		...
		try {
			File file = fileFinder.ShowFileBrowserDialog("Verifyta", engineExstension,(new Verifyta()).getPath());
	...
	private void selectVerifypnEngine() {
		...
		try {
			File file = fileFinder.ShowFileBrowserDialog("Verifypn", engineExstension,(new VerifyPN(new FileFinder(), new MessengerImpl())).getPath());
			if(file != null){
