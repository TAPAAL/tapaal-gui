...
public class LessThanEqExpression extends GuardExpression implements LeftRightGuardExpression {
    ...
    public boolean equals(Object o) {
        if (o instanceof LessThanEqExpression) {
            LessThanEqExpression expr = (LessThanEqExpression) o;
