...
public class Constants {
    ...
    public static final String VERIFYTAPN_MIN_REV = "1.4.0";
    public static final String VERIFYDTAPN_MIN_REV = "3.7.0";
    public static final String VERIFYPN_MIN_REV = "4.5.0";
