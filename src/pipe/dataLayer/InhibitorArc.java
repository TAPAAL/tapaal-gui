...
public class InhibitorArc extends Arc {
	/*
	 * CB Joakim Byg - propably not needed public final static String type =
	 * "inhibitor"; EOC
	 */
	...
	/*
	 * CB Joakim Byg - This is sortof ugly, since it is only used one place and
	 * we would like to make an other type of arc that inherits from NormalArc
	 * public String getType(){ return this.type; } EOC
	 */
