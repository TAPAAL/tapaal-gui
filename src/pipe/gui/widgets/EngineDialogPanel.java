...
public class EngineDialogPanel {	
	...
	private void selectdTapnEngine() {
		...
		if (verifytapnpath != null) {
			VerifyTAPNDiscreteVerificationWA verifyTapn = new VerifyTAPNDiscreteVerificationWA(fileFinder,messenger);
			verifyTapn.setVerifydTapnWAPath(verifytapnpath);
			setPathsAndVersionNumbers();
			fitDialog();
		}
	}
	...
	private void resetVerifydtapnEngine() {
		VerifyTAPNDiscreteVerificationWA.reset();
		setPathsAndVersionNumbers();
	}
	...
	private void setPathsAndVersionNumbers() {
		...
		VerifyTAPNDiscreteVerificationWA verifydTAPN = new VerifyTAPNDiscreteVerificationWA(new FileFinderImpl(), new MessengerImpl());
