...
class NativeFileBrowser extends FileBrowser {
    ...
    NativeFileBrowser(String filetype, final String ext, final String optionalExt, String path) {
        ...
        if (!ext.equals("")) {
            if (!optionalExt.equals("")) {
                fc.setFilenameFilter((dir, name) -> name.endsWith(ext) || name.endsWith(optionalExt));
            } else {
                fc.setFilenameFilter((dir, name) -> name.endsWith(ext));
            }
        }
    }
    ...
    public File openFile() {
        ...
        if (optionalExt.equals("")) {
            ...
            fc.setFile(ext.equals("") ? "" : ("*." + ext + ";*." + optionalExt));
        }
